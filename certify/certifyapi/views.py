...
def emailcertificate_view2(request):
    ...
    send_mail(
        received_parameters['name'],
        'This is autogenerated mail. ' + "link comes here",
        "harshithtunuguntla@gmail.com",
        ['harshith.tunuguntla.19cse@bmu.edu.in'],
    )
    print("pass")
...
def emailcertificate_view(request):
    ...
    if(received_parameters['participant_id']==None):
        err += " [participant id null] "
        return_status=True
    if(received_parameters['email']==None):
        err += " [email id null] "
        return_status=True
    ...
    if(Certificates.objects.filter(participant_id=received_parameters['participant_id'],event_code=received_parameters['event_code']).exists()):
        ...
        send_mail(
        received_parameters['name'],
        'This is autogenerated mail. ' + "This is the link to access your certificate : " + str(certificateobj[0].certificate_link) + " with UID : " + str(certificateobj[0].uid_number),
        "mymailid@gmail.com",
        [received_parameters['email']],
        )
